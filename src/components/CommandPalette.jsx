...
function CommandPalette({ language, theme, toggleTheme, toggleLanguage }) {
  ...
  const actions = useMemo(() => {
    ...
    return [
      ...
      { id: "fun-quest", title: zh ? "Fun · Terminal 解谜" : "Fun · Terminal Quest", group: funGroup, keywords: ["quest", "unlock", "terminal", "解谜", "口令"], run: scrollTo("mod-quest") },
      { id: "fun-typing", title: zh ? "Fun · 代码打字挑战" : "Fun · Code Typing", group: funGroup, keywords: ["typing", "wpm", "打字"], run: scrollTo("mod-typing") },
      { id: "fun-bughunt", title: zh ? "Fun · Bug Hunt" : "Fun · Bug Hunt", group: funGroup, keywords: ["bug", "debug", "challenge", "调试"], run: scrollTo("mod-bughunt") },
      { id: "fun-quiz", title: zh ? "Fun · 代码人格测试" : "Fun · Developer Quiz", group: funGroup, keywords: ["quiz", "personality", "人格", "测试"], run: scrollTo("mod-quiz") },
